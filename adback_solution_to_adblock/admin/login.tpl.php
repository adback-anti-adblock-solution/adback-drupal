...
<div id="ab-login">
    <div class="ab-col-md-12">
        <div class="ab-login-box">
            ...
            <center><a href="https://www.adback.co" target="_blank"><div class="ab-login-logo" style="background-image:url('<?php echo  $GLOBALS['base_url'] .'/'. drupal_get_path('module', 'adback'); ?>/admin/images/_dback.png');"></div></a></center>
            ...
            <center>
                <button
                    ...
                    data-email="<?php echo variable_get('site_mail', ini_get('sendmail_from'));?>"
                >
